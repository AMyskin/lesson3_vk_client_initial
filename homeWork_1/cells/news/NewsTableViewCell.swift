...
class NewsTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        imageViewLike.tintColor = .myLightGray
        imageViewShare.tintColor = .myLightGray
        imageViewComment.tintColor = .myLightGray
        imageViewViews.tintColor = .myLightGray
    }
    ...
    func configure(feed: NewsViewsModel) {
        
        labelDate.text = feed.dateLabelText
        labelFeedGroupHeader.text = feed.labelFeedGroupHeaderText
        
        if feed.labelFeedGroupHeaderText.count == 0 {
            labelText.pin.height(0)
        } else {
            labelText.pin.height(70)
        }
        
        labelText.text = feed.labelText
